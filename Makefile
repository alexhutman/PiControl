...
SERVER_OBJS    := $(SRC_DIR)/picontrol_server.o $(SRC_DIR)/networking/iputils.o $(SRC_DIR)/networking/websocket_protocol.o $(SRC_DIR)/serialize/protocol.o $(SRC_DIR)/backend/picontrol_uinput.o $(SRC_DIR)/backend/picontrol_backend.o $(SRC_DIR)/model/protocol.o
